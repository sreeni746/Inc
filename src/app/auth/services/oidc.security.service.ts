...
export class OidcSecurityService {
    ...
    setRedirectUrl(url: string): void {
        this.oidcSecurityCommon.sessionRedirect = url;
    }

    getRedirectUrl(): string {
        return this.oidcSecurityCommon.sessionRedirect;
    }

    setRights(rights: Usercontext): void {
        this.oidcSecurityCommon.sessionRights = rights;
    }

    getRights(): Usercontext {
        return this.oidcSecurityCommon.sessionRights;
    }
