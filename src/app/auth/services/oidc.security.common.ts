...
export class OidcSecurityCommon {
    ...
    private storage_session_redirect = 'session_redirect';
    public get sessionRedirect(): any {
        return this.retrieve(this.storage_session_redirect);
    }

    public set sessionRedirect(value: any) {
        this.store(this.storage_session_redirect, value);
    }

    private storage_session_rights = 'session_rights';
    public get sessionRights(): Usercontext {
        return this.retrieve(this.storage_session_rights);
    }

    public set sessionRights(value: Usercontext) {
        this.store(this.storage_session_rights, value);
    }
    ...
    resetStorageData(isRenewProcess: boolean) {
        if (!isRenewProcess) {
            ...
            this.store(this.storage_session_rights, null);
        }
    }
